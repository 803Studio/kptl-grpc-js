...
function serialize_job_Company(arg) {
  if (!(arg instanceof job_Job_pb.Company)) {
    throw new Error('Expected argument of type job.Company');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_job_Company(buffer_arg) {
  return job_Job_pb.Company.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_job_FindCompanyByIndustryReq(arg) {
  if (!(arg instanceof job_Job_pb.FindCompanyByIndustryReq)) {
    throw new Error('Expected argument of type job.FindCompanyByIndustryReq');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_job_FindCompanyByIndustryReq(buffer_arg) {
  return job_Job_pb.FindCompanyByIndustryReq.deserializeBinary(new Uint8Array(buffer_arg));
}
...
updateJobs: {
  ...
  registeredCompany: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: job_Job_pb.Company,
    responseType: job_Job_pb.CommonResponse,
    requestSerialize: serialize_job_Company,
    requestDeserialize: deserialize_job_Company,
  ...
  findCompanyByIndustry: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: job_Job_pb.FindCompanyByIndustryReq,
    responseType: job_Job_pb.CommonCompanyResponse,
    requestSerialize: serialize_job_FindCompanyByIndustryReq,
    requestDeserialize: deserialize_job_FindCompanyByIndustryReq,
    responseSerialize: serialize_job_CommonCompanyResponse,
    responseDeserialize: deserialize_job_CommonCompanyResponse,
  },
};
