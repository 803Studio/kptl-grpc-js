...
interface IEmployeeService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  completeSelfInformation: grpc.MethodDefinition<employee_employee_pb.SelfInformation, global_headers_pb.ResponseHeader>;
...
export interface IEmployeeServer extends grpc.UntypedServiceImplementation {
  ...
  completeSelfInformation: grpc.handleUnaryCall<employee_employee_pb.SelfInformation, global_headers_pb.ResponseHeader>;
...
export class EmployeeClient extends grpc.Client {
  ...
  completeSelfInformation(argument: employee_employee_pb.SelfInformation, callback: grpc.requestCallback<global_headers_pb.ResponseHeader>): grpc.ClientUnaryCall;
  completeSelfInformation(argument: employee_employee_pb.SelfInformation, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<global_headers_pb.ResponseHeader>): grpc.ClientUnaryCall;
  completeSelfInformation(argument: employee_employee_pb.SelfInformation, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<global_headers_pb.ResponseHeader>): grpc.ClientUnaryCall;
