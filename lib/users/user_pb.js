...
goog.object.extend(proto, comm_headers_pb);
...
goog.exportSymbol('proto.users.UserRole', null, global);
/**
...
proto.users.LoginResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    header: (f = msg.getHeader()) && comm_headers_pb.ResponseHeader.toObject(includeInstance, f),
...
proto.users.LoginResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new comm_headers_pb.ResponseHeader;
      reader.readMessage(value,comm_headers_pb.ResponseHeader.deserializeBinaryFromReader);
      msg.setHeader(value);
      break;
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.users.UserRole} */ (reader.readEnum());
      msg.setRole(value);
      break;
    default:
      reader.skipField();
...
proto.users.LoginResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      comm_headers_pb.ResponseHeader.serializeBinaryToWriter
    );
  }
  f = message.getUid();
  if (f !== 0) {
...
/**
 * optional comm.ResponseHeader header = 1;
 * @return {?proto.comm.ResponseHeader}
 */
proto.users.LoginResponse.prototype.getHeader = function() {
  return /** @type{?proto.comm.ResponseHeader} */ (
    jspb.Message.getWrapperField(this, comm_headers_pb.ResponseHeader, 1));
};


/**
 * @param {?proto.comm.ResponseHeader|undefined} value
 ...
 * @return {!proto.users.UserRole}
 */
proto.users.LoginResponse.prototype.getRole = function() {
  return /** @type {!proto.users.UserRole} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.users.UserRole} value
 * @return {!proto.users.LoginResponse} returns this
 */
proto.users.LoginResponse.prototype.setRole = function(value) {
